...
class NotesListAdapter extends RecyclerView.Adapter<NotesListAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void applySettings() {
            ...
            noteTitle.setTextSize(TypedValue.COMPLEX_UNIT_DIP, fontSize);
            noteDate.setTextSize(TypedValue.COMPLEX_UNIT_DIP, fontSize);
            noteTime.setTextSize(TypedValue.COMPLEX_UNIT_DIP, fontSize);
        }
    }
